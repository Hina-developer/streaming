  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { name: 'Nora Abdullah', role: 'Khobar, KSA', text: 'Tried 3 other providers before — none compare to Prime Streams. The movie library alone is worth every riyal.' },
      ],
    },
    faq: {
    ...
    whatsapp: {
      title: 'Prime Streams Support',
      status: 'Online — Typically replies instantly',
      greeting: 'Hi there! 👋 Welcome to Prime Stream.',
  ...
  ar: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { name: 'نورة عبدالله', role: 'الخبر، السعودية', text: 'جربت 3 مزودين آخرين قبل — لا شيء يقارن مع Prime Streams. مكتبة الأفلام وحدها تستحق كل ريال.' },
      ],
    },
    faq: {
    ...
    footer: {
      ...
      copyright: '© 2026 Prime Streams. جميع الحقوق محفوظة.',
      rights: 'جميع الحقوق محفوظة.',
    },
    whatsapp: {
      title: 'دعم Prime Streams',
      status: 'متصل — يرد عادة فوراً',
      greeting: 'مرحباً! 👋 أهلاً بك في Prime Streams .',
